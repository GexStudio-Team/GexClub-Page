...
export const EVENTS = [
  {
    ...
    date: '2026-10-31',
    startAt: '2026-10-31T08:30:00-05:00',
...
export const PROJECTS = [
  {
    ...
    description: 'Terminal navegable dentro de la web: el core de Gex Club con comandos reales, neofetch y lluvia digital. Diseñada y desarrollada por Duvan Altamar.',
    longDescription: 'Una terminal interactiva embebida en el sitio — diseñada y desarrollada por Duvan Altamar — que convierte la visita en una experiencia de sistema operativo. Escribe help, explora el vault con ls/cat, consulta el hackathon activo y activa el modo matrix. Todo alimentado desde el contenido central del sitio.',
    category: 'software',
    tech: ['React 19', 'Next.js 16', 'Tailwind CSS 4', 'Canvas'],
    members: 'GexStudio Team',
    developer: 'Duvan Altamar',
...
export const DUVAN_ALTAMAR = {
  name: 'Duvan Altamar',
  role: 'Fundador · GexStudio Team',
  instagram: 'https://www.instagram.com/duvanltbaq/',
